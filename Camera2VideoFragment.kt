...
class Camera2VideoFragment : Fragment(), View.OnClickListener,
    ...
    private var HScaptureSession: CameraConstrainedHighSpeedCaptureSession? = null
    /**
    ...
    private fun updatePreview() {
        ...
        try {
            if(isRecordingVideo) {
                ...
                Log.d("IN UPDATE PREVIEW", "RECORDING TRUE")
                HandlerThread("CameraHighSpeedPreview").start()
                var builderBurst = HScaptureSession?.createHighSpeedRequestList(previewRequestBuilder.build())
                HScaptureSession?.setRepeatingBurst(builderBurst,null,backgroundHandler)
            }else{
    ...
    private fun setUpCaptureRequestBuilder(builder: CaptureRequest.Builder?) {
        ...
        builder?.set(CaptureRequest.CONTROL_AE_TARGET_FPS_RANGE, Range(240,240))
    }
    ...
    private fun setUpMediaRecorder() {
        ...
        mediaRecorder?.apply {
            ...
            setVideoEncodingBitRate(30000000)
        ...
        try {
            ...
            cameraDevice?.createConstrainedHighSpeedCaptureSession(surfaces,
                ...
                override fun onConfigured(cameraCaptureSession: CameraCaptureSession) {
                    ...
                    HScaptureSession = captureSession as CameraConstrainedHighSpeedCaptureSession
    ...
    private fun stopRecordingVideo() {
        ...
        try {
            HScaptureSession?.stopRepeating()
